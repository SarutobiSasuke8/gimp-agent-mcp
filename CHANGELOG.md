...
The detailed-work release: measurement, comparison renders, selection and masks, text, paths, effect editing, AI cut-outs and a recipe library. 32 tools, 7 recipes, 20 live checks.
